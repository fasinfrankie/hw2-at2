...
-- batman1 = Movie.where({title: "Batman Begins"})[0]

-- people = Person.where({ movie_id: batman1.id})


-- batman2 = Movie.where({title: "The Dark Knight"})[0]
-- # puts batman2.id
-- batman3 = Movie.where({title: "The Dark Knight Rises"})[0]
-- # puts batman3.id
